...
| 3 | **Core Workflow** — build → run → push, common commands | [`docker/03-workflow.md`](./docker/03-workflow.md) | ~5 min |
| 4 | **Docker Compose** — multi-container apps + private networking | [`docker/04-compose.md`](./docker/04-compose.md) | ~6 min |
| 5 | **ECR** — AWS's private registry, auth flow, push/pull | [`docker/05-ecr.md`](./docker/05-ecr.md) | ~5 min |
| 6 | **Common Pitfalls & Gotchas** — the traps everyone hits | [`docker/06-pitfalls.md`](./docker/06-pitfalls.md) | ~8 min |
| 7 | **Cheat-Sheet** — one-liner command reference | [`docker/07-cheatsheet.md`](./docker/07-cheatsheet.md) | reference |
| 8 | **Week 4 Lab Sequence** — 5-day hands-on plan + repo scaffold | [`docker/08-week4-lab.md`](./docker/08-week4-lab.md) | ~4 min |
...
- **New to Docker?** → Read files 1 → 8 in order.
